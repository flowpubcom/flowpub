...
const es = {
  ...
  // Presentación por voz del perfil (audio breve, sin transcript)
  "intro.label": "Su voz",
  "intro.labelOwn": "Tu voz",
  "intro.cta": "Preséntate con tu voz",
  "intro.recording": "Cuéntanos quién eres…",
  "intro.stop": "Listo",
  "intro.saving": "Guardando…",
  "intro.rerecord": "Grabar de nuevo",
  "intro.remove": "Quitar mi presentación",
  "intro.err.mic": "No pudimos usar tu micrófono. Revisa el candadito del navegador.",
  "intro.err.short": "Quedó muy cortita. Intenta de nuevo.",
  "intro.err.save": "No se pudo guardar tu presentación. Inténtalo otra vez.",
  "intro.err.pending": "Todavía no podemos guardar presentaciones de voz. Ya lo estamos arreglando.",
  ...
  "profile.since": "En el Flow desde el {date}",
  ...
  "profile.origin": "De dónde eres · opcional",
  "profile.city": "Ciudad",
  "profile.state": "Estado",
  "profile.country": "País",
  "profile.website": "Página web · opcional",
  "profile.websitePlaceholder": "tusitio.com",
  "profile.socials": "Redes sociales · opcional",
  "profile.socialPlaceholder": "usuario",
  ...
  "crop.zoom": "Zoom",
  "emoji.aria": "Agregar emoji",
  "avatar.crop.title": "Ajusta tu foto",
  "avatar.crop.hint": "Arrastra para mover, desliza para acercar.",
  "avatar.crop.confirm": "Usar esta foto",
  "avatar.pick": "Sube una foto",
  "avatar.change": "Cambiar foto",
  "cover.crop.title": "Ajusta la portada",
  "cover.crop.hint": "Arrastra para mover, desliza para acercar. Va en formato horizontal.",
  "cover.crop.confirm": "Usar esta portada",
} as const;
...
const en: Record<DictKey, string> = {
  ...
  "intro.label": "Their voice",
  "intro.labelOwn": "Your voice",
  "intro.cta": "Introduce yourself with your voice",
  "intro.recording": "Tell us who you are…",
  "intro.stop": "Done",
  "intro.saving": "Saving…",
  "intro.rerecord": "Record again",
  "intro.remove": "Remove my intro",
  "intro.err.mic": "We couldn't use your microphone. Check the lock icon in your browser.",
  "intro.err.short": "That was too short. Give it another go.",
  "intro.err.save": "We couldn't save your intro. Please try again.",
  "intro.err.pending": "We can't save voice intros just yet. We're on it.",
  ...
  "crop.zoom": "Zoom",
  "emoji.aria": "Add emoji",
  "avatar.crop.title": "Adjust your photo",
  "avatar.crop.hint": "Drag to move, slide to zoom.",
  "avatar.crop.confirm": "Use this photo",
  "avatar.pick": "Upload a photo",
  "avatar.change": "Change photo",
  "cover.crop.title": "Adjust the cover",
  "cover.crop.hint": "Drag to move, slide to zoom. It's shown in landscape.",
  "cover.crop.confirm": "Use this cover",
};
